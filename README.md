...
A full-stack language tutor platform built with **React Router v7** (SSR), **Firebase**, and **Tailwind CSS**. Browse qualified language teachers, filter by language, level, and price, and save your favourites — all with real-time data and authenticated sessions.
...
- 👩‍🏫 **Teachers Page** – Browse tutors with filters by teaching language, student level, and price per hour
...
[[redirects]]
  from = "/*"
  to = "/.netlify/functions/react-router-server"
  status = 200
```
...
**Engapantio** – [@engapantio](https://github.com/engapantio)
